...
| :-------------------- | :--------------- | :------------------------------------------------- |
| **Paragraph**         | `<p>`            | Supports bold, italic, links, etc.                 |
| **Headings**          | `H2`, `H3`, `H4` | Maps H1 -> H2 for better SEO structure.            |
| **Lists**             | `<ul>`, `<ol>`   | Supports nested lists.                             |
| **Toggle**            | `<details>`      | Converts to an interactive Accordion.              |
| **Quote**             | `<blockquote>`   |                                                    |
| **Image**             | `<figure>`       | Includes captions and lazy loading.                |
| **Video**             | `<video>`        | Native HTML5 video player.                         |
| **Code**              | `<pre><code>`    | **Prism.js** syntax highlighting + Copy button.    |
| **Code (HTML Embed)** | Raw HTML         | Set caption to "Embed" to render raw HTML/Scripts. |
| **Divider**           | `<hr>`           | Uses Webflow's separator class.                    |
